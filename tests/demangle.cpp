...
using items = std::pair<string_type, string_type>;

constexpr const items general[] =
{
...
constexpr const items withPostfix[] =
{
...
constexpr const items withPrefix[] =
{
    ...
    {"_ZN12hb_partial_tI8._anon_0E1mIiJEEEDTcl4sinkcl6sourceIS0_EEspcvT0__EEEOT_DpOS3_", "decltype (sink((source<._anon_0>)())) hb_partial_t<._anon_0>::m<int>(int&&)"}
};

template <std::size_t N>
void demangle(const items (&pairs)[N])
{
